...
(defface eye-view-lighter
    '((((class color) (min-colors 88) (background light)) (:foreground "#8e44ad" :height 1.2 :family "FontAwesome"))
      (((class color) (min-colors 88) (background dark)) (:foreground "#9b59b6" :height 1.2 :family "FontAwesome"))
      (((class color) (min-colors 16) (background light)) (:foreground "#8e44ad" :height 1.2 :family "FontAwesome"))
      (((class color) (min-colors 16) (background dark)) (:foreground "#9b59b6" :height 1.2 :family "FontAwesome"))
